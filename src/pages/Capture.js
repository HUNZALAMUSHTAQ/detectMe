...
function Capture() {
    ...
    const handleFileUploading = () => {
        ...
        axios.post('http://18.130.175.129:8000/api/addImg', data, { "Content-Type": "multipart/form-data" }).then(res => {
            console.log(res)
        ...
        <div>
            ...
            >
                <Box sx={style}>
                    ...
                    <Stack mt={4}>
                        <TextField onChange={(e) => setName(e.target.value)} value={name} id="outlined-basic" label="Enter your name " variant="outlined" />
                    </Stack>
                    <Stack mt={4}>
